...
4. Review `../floorplans/2012-wildcat-29mk-floorplan-clockwise.webp` for the corrected clockwise camper rotation with the original header and footer upright.
5. Use `overlays/requested-campsite-footprint.svg` as the dimensioned, scale-controlled footprint template for the RV and 10 × 15 ft canopy.
6. Review the static files in `generated/` after the map-build workflow runs.
