...
PASSES: list[Pass] = [
    ...
    Pass(
        ...
        area_note="393 + 105 + 102 = 600 sq ft",
...
_ss_shower_core = Pass(
    ...
    area_sqft=393,
    area_note="393 sq ft notched section; separate accepted walkway uses 105 sq ft",
...
DETACHED_PARTS: list[Pass] = [
    ...
    Pass(
        ...
        source=_ss_shower_source.source,
        rect=(10.2, 10),
        default_bbox_origin=(145.5, 229.5),
