# Cummins Onan P4500i Generator Inventory

_Last reviewed: July 27, 2026_

## Equipment on hand

| Item | Quantity | Fuel | Intended TRF use |
|---|---:|---|---|
| Cummins Onan P4500i inverter generator | 2 | Gasoline | Camper power, including one generator per air conditioner or combined operation with a compatible parallel kit |

## Specifications per generator

| Specification | Rating |
|---|---:|
| Running output | 3,700 W |
| Peak/startup output | 4,500 W |
| Rated output | 120 V, 60 Hz, single phase |
| Running current | 30.8 A at 120 V |
| Peak current | 37.5 A at 120 V |
| Total harmonic distortion | 3% or less |
| Engine | 224 cc, 7.3 hp, OHV four-stroke |
| Fuel tank | 3.4 gal (12.8 L) |
| Published runtime | Up to 18 hours at 25% load |
| Dry weight | Approximately 98 lb |
| Approximate dimensions | 24.5 × 18.25 × 20.5 in |
| Published noise level | As low as 52 dBA |
| Starting methods | Push-button electric, wireless remote and recoil pull cord |
| AC outlets | One 120 V 30 A TT-30R RV outlet and one duplex 120 V 20 A 5-20R outlet |
| USB outlets | Two 5 V USB ports |
| Neutral configuration | Floating neutral |
| Oil | SAE 10W-30 |
| Oil capacity | Approximately 0.63 US qt (0.60 L / 20.3 oz) |
| Fuel requirement | Unleaded gasoline, 87–93 octane, no more than 10% ethanol; do not use E15 or E85 |
...
| Unit | Serial number | Purchase date | Current hours | Last oil change | Notes |
|---|---|---|---:|---|---|
| P4500i #1 |  |  |  |  |  |
| P4500i #2 |  |  |  |  |  |
