...
| S. and T. | Tent + handicap portapotty | Per-pass layout uses an assumed 10 × 20 ft tent and 6 × 6 ft unit in separate end zones linked by a 4 × 30 ft connector path; the georeferenced v0.1 overlay still has the legacy placeholder |
...
9. Use a two-ended 600 sq ft pass for S. and T.: a 12 × 22 ft tent end, 4 × 30 ft connector path, and 12 × 18 ft portapotty end.
...
- S. and T.'s revised two-ended pass is available in the freeform per-pass layout, but has not yet been folded back into the georeferenced v0.1 overlay.
